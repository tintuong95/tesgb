...
let FeedbackService = class FeedbackService {
    ...
    async findOneAsync(id, user) {
        try {
            ...
            if (!result)
                throw new common_2.NotFoundException('Feedback Id ' + id + ' Not Found !');
            return result;
        }
        catch (err) {
            console.log(err);
    ...
    async createAsync(createFeedbackDto, user) {
        try {
    ...
    async updateAsync(id, updateFeedbackDto, user) {
        try {
...
FeedbackService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(core_1.Feedback)),

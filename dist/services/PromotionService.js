...
let PromotionService = class PromotionService {
    ...
    async findOneAsync(id, user) {
        try {
            ...
            if (!result)
                throw new common_2.NotFoundException('Promotion Id ' + id + ' Not Found !');
            return result;
        }
        catch (err) {
            console.log(err);
    ...
    async createAsync(createPromotionDto, user) {
        try {
    ...
    async updateAsync(id, updatePromotionDto, user) {
        try {
...
PromotionService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(core_1.Promotion)),

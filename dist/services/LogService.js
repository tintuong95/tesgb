...
let LogService = class LogService {
    ...
    async findOneAsync(id, user) {
        try {
            ...
            if (!result)
                throw new common_2.NotFoundException('Log Id ' + id + ' Not Found !');
            return result;
        }
        catch (err) {
            console.log(err);
    ...
    async createAsync(createLogDto, user) {
        try {
    ...
    async updateAsync(id, updateLogDto, user) {
        try {
    ...
    async removeAsync(id, user) {
        ...
        if (result.affected > 0)
            return 'Deleted Log Id ' + id + ' successfully !';
        throw new common_2.NotFoundException('Log Id ' + id + ' Not Found !');
    }
    async restoreAsync(id, user) {
        ...
        if (result.affected > 0)
            return 'Restore Log Id ' + id + ' successfully !';
        throw new common_2.NotFoundException('Log Id ' + id + ' Not Found !');
    }
...
LogService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(core_1.Log)),

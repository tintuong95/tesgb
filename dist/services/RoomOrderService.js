...
exports.RoomOrderService = void 0;
...
let RoomOrderService = class RoomOrderService {
    constructor(roomOrderRepository) {
    ...
    async findOneAsync(id, user) {
        try {
            ...
            if (!result)
                throw new common_2.NotFoundException('RoomOrder Id ' + id + ' Not Found !');
            return result;
        }
        catch (err) {
            console.log(err);
    ...
    async createAsync(createRoomOrderDto) {
        try {
    ...
    async updateAsync(id, updateRoomOrderDto, user) {
        try {
...
RoomOrderService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(core_1.RoomOrder)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], RoomOrderService);
exports.RoomOrderService = RoomOrderService;
//# sourceMappingURL=RoomOrderService.js.map
...
MemberModule = __decorate([
    (0, common_1.Module)({
        controllers: [core_2.MemberController],
        providers: [core_3.MemberService],
        imports: [typeorm_1.TypeOrmModule.forFeature([core_1.Member])],
        exports: [typeorm_1.TypeOrmModule, core_3.MemberService],
    })
], MemberModule);

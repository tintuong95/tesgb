...
UnitModule = __decorate([
    (0, common_1.Module)({
        controllers: [core_2.UnitController],
        providers: [core_3.UnitService],
        imports: [typeorm_1.TypeOrmModule.forFeature([core_1.Unit])],
        exports: [typeorm_1.TypeOrmModule, core_3.UnitService],
    })
], UnitModule);
exports.UnitModule = UnitModule;
//# sourceMappingURL=UnitModule.js.map